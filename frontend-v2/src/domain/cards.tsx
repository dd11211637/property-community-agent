...
import type { AnnouncementModel, BillModel, CardVariant, HouseModel, InspectionTaskModel, ResidentModel, SecurityEventModel, WorkOrderModel } from "../models/viewModels";
...
export function WorkOrderCard({ value, variant = "default" }: { value: WorkOrderModel; variant?: CardVariant }) {
...
export function BillCard({ value, variant = "default" }: { value: BillModel; variant?: CardVariant }) {
...
export function AnnouncementCard({ value, variant = "default", compact = false }: { value: AnnouncementModel; variant?: CardVariant; compact?: boolean }) {
...
export function ResidentCard({ value, variant = "default" }: { value: ResidentModel; variant?: CardVariant }) {
...
export function HouseCard({ value, variant = "default" }: { value: HouseModel; variant?: CardVariant }) {
...
export function InspectionTaskCard({ value, variant = "default" }: { value: InspectionTaskModel; variant?: CardVariant }) {
...
export function SecurityEventCard({ value, variant = "default" }: { value: SecurityEventModel; variant?: CardVariant }) {
