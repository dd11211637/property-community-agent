...
export function ConfirmDialog({ title, summary, confirmLabel = "确认提交", onConfirm, onClose }: Props) {
    ...
    <div className="dialog-backdrop" role="presentation">
      <section className="dialog" role="dialog" aria-modal="true" aria-labelledby="confirm-title">
        ...
        <div className="dialog-actions">
          <button className="button ghost" onClick={onClose} disabled={pending}>取消</button>
